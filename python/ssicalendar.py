...
def createExcel(monList, workbookFP, month, year):
    workbook = xlsxwriter.Workbook("C:\\Users\\tseguia\\Documents\\SSI CALENDAR\\firstquarter2021\\" + month + year + ".xlsx")
...
filePath = "C:\\Users\\tseguia\\Documents\\SSI CALENDAR\\firstquarter2021\\1stquarter2021.txt" #CHANGE WITH EACH QUARTER #CHANGE

workbookFP = "C:\\Users\\tseguia\\Documents\\SSI CALENDAR\\firstquarter2021\\" #CHANGE WITH EACH QUARTER #CHANGE
...
workbookFP2 = workbookFP + monthOne + year + ".xlsx"
workbookFP3 = workbookFP + monthOne + year + ".xlsx"
